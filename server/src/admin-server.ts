...
import SkillRoute from './routes/admin/Skill';
import ProgramRoute from './routes/admin/Program';
import CollectionRoute from './routes/admin/Collection';
import TestRoute from './routes/admin/Test';
