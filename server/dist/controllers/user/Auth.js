...
const Login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let user = yield User_1.default.findOne({ email: profile.email });
    if (!user) {
    ...
    yield (0, CreateCookie_1.CreateAuthCookie)(res, user);
...
const Logout = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield User_1.default.findById(req.user._id).select('refreshTokens');
    if (user) {
