...
const Skill_2 = __importDefault(require("./routes/user/Skill"));
const Program_2 = __importDefault(require("./routes/user/Program"));
const Collection_2 = __importDefault(require("./routes/user/Collection"));
const Test_2 = __importDefault(require("./routes/user/Test"));
