...
skillsRouter.route('/delete/:id').all(VerifyAdmin_1.default).post(Skill_1.DeleteSkillByID);
skillsRouter.route('/add-resources/:id').all(VerifyAdmin_1.default).post(Skill_1.AddResources);
skillsRouter.route('/delete-resource/:id/:resourceID').all(VerifyAdmin_1.default).post(Skill_1.DeleteResourceByID);
